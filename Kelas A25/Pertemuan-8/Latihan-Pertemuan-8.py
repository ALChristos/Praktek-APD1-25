...
# # # # tabel = PrettyTable()
# # # # tabel.field_names = ["nama", "umur"]
# # # # tabel.add_row(["agus", 25])
# # # # v = ["van", 20]
# # # # tanaman = [{"nama": "Melati",
# # # #            "umur": 21
# # # #             }]
# # # # a = list(tanaman[0].keys())
# # # # tabel = PrettyTable()
# # # # tabel.field_names = ["No"] + a
# # # # # tabel = PrettyTable()
# # # # # tabel.field_names = list(tanaman[0].keys())
# # # # # for i in tanaman:
# # # #     # tabel.add_row(list(tanaman[0].values()))
...
# # #      "Puk" : 20}]
# # # tabel = PrettyTable()
# # # tabel.field_names = ["No"] + list(a[0].keys())
...
# # stok_PV = [{"pupuk": 13,
# #            "vitamin": 8}]
# # print(stok_PV[0]["pupuk"])
# a = "Aku ABC"
# laporan = [{"laporan": ["1. abc", 
#                         "2. abcd"]}]
# laporan[0]["laporan"].append(a)
# tabel6 = PrettyTable()
# tabel6.field_names = ["No"] + list(laporan[0].keys())
# for i, o in enumerate(laporan[0]["laporan"], start=1):
#     tabel6.add_row([i] + [o])
# # print(tabel6)
# # print(len(laporan[0]["laporan"]))
# print(laporan[0]["laporan"])
